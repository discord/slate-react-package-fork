...
import { PathUtils, Block, Value, Range, Editor, Node } from 'slate';
...
function BeforePlugin() {
  ...
  function onBeforeInput(event, editor, next) {
    if (!window.NO_SLATE_LOGGING) console.log('!! onBeforeInput with data:' + event.data + ' inputType:' + event.inputType + ' has2:' + HAS_INPUT_EVENTS_LEVEL_2 + ' isSynthetic:' + !!event.nativeEvent);
