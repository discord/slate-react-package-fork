...
var ZeroWidthString = function ZeroWidthString(_ref2) {
  var _ref3;

  var _ref2$length = _ref2.length,
      length = _ref2$length === undefined ? 0 : _ref2$length,
      _ref2$isLineBreak = _ref2.isLineBreak,
      isLineBreak = _ref2$isLineBreak === undefined ? false : _ref2$isLineBreak;

  return React.createElement(
    'span',
    (_ref3 = {}, defineProperty(_ref3, DATA_ATTRS.ZERO_WIDTH, isLineBreak ? 'n' : 'z'), defineProperty(_ref3, DATA_ATTRS.LENGTH, length), _ref3),
    '\uFEFF',
...
function BeforePlugin() {
  ...
  function onBeforeInput(event, editor, next) {
    ...
    if (isSynthetic) {
      ...
      var hasNewLines = event.data != null && event.data.indexOf('\n') >= 0;
