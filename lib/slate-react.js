...
var Inline = function (_React$Component) {
  ...
  function Inline() {
    ...
    return _ret = (_temp = (_this = possibleConstructorReturn(this, (_ref = Inline.__proto__ || Object.getPrototypeOf(Inline)).call.apply(_ref, [this].concat(args))), _this), _this.ref = React.createRef(), _temp), possibleConstructorReturn(_this, _ret);
  }
...
var Leaf = function (_React$Component) {
  ...
  createClass(Leaf, [{
    ...
    value: function shouldComponentUpdate(nextProps) {
      ...
      var shouldHaveLineBreak = slateDevEnvironment.IS_FIREFOX && isLineBreak || !slateDevEnvironment.IS_FIREFOX && (isLineBreak || isOnly);
...
var Block = function (_React$Component) {
  ...
  function Block() {
    ...
    return _ret = (_temp = (_this = possibleConstructorReturn(this, (_ref = Block.__proto__ || Object.getPrototypeOf(Block)).call.apply(_ref, [this].concat(args))), _this), _this.tmp = { nodeRefs: {} }, _this.ref = React.createRef(), _temp), possibleConstructorReturn(_this, _ret);
  }
    ...
    value: function render() {
      ...
      var _loop = function _loop(child) {
        ...
        if (child.object === 'block') {
          children.push(React.createElement(Block, {
            ref: refFn,
            key: child.key,
            editor: editor,
            node: child,
...
var Document = function (_React$Component) {
  ...
  createClass(Document, [{
    ...
    value: function render() {
      ...
      var _loop = function _loop(child) {
        var Component = child.object === 'text' ? Text : child.object === 'block' ? Block : Inline;
        var i = children.length;
...
var Content = function (_React$Component) {
  ...
  function Content() {
    ...
    return _ret = (_temp = (_this = possibleConstructorReturn(this, (_ref = Content.__proto__ || Object.getPrototypeOf(Content)).call.apply(_ref, [this].concat(args))), _this), _this.tmp = {
      ...
      if (editor.isComposing() && slateDevEnvironment.HAS_INPUT_EVENTS_LEVEL_2) return;
...
function QueriesPlugin() {
  ...
  function findPath(editor, element) {
    ...
    var key = nodeElement.getAttribute(DATA_ATTRS.KEY);
...
var debug$1 = Debug('slate:composition-manager');
...
function CompositionManager(editor) {
  ...
  function splitBlock() {
    ...
    renderSync(editor, function () {
      ...
      if (last.range) {
        ...
        debug$1('splitBlock:NO-SELECTION');
      }
  ...
  function flushAction(mutations) {
    debug$1('flushAction', mutations.length, mutations);
  ...
  function resolveDOMNode(domNode) {
    ...
    debug$1('resolveDOMNode:diff', last.diff);
  }
  ...
  function onCompositionEnd() {
    ...
    window.setTimeout(function () {
      if (last.diff) {
        debug$1('onCompositionEnd:applyDiff');
  ...
  function onSelect(event) {
    ...
    onSelectTimeoutId = window.requestAnimationFrame(function () {
      debug$1('onSelect:save-selection');
      ...
      if (domSelection.isCollapsed && last.node !== domSelection.anchorNode && last.diff != null) {
        debug$1('onSelect:applyDiff', last.diff);
        applyDiff();
        editor.select(range);
        clearAction();
      }
...
var debug$3 = Debug('slate:before');
...
function BeforePlugin() {
  ...
  function onBeforeInput(event, editor, next) {
    /* prettier-ignore */if (window.ENABLE_SLATE_LOGGING) console.log('!! onBeforeInput with data:' + JSON.stringify(event.data) + ' inputType:' + event.inputType + ' has2:' + slateDevEnvironment.HAS_INPUT_EVENTS_LEVEL_2 + ' isSynthetic:' + !!event.nativeEvent);
  ...
  function onSelect(event, editor, next) {
    if (isCopying) return;
    if (editor.readOnly) return;
    if (checkIsComposing() && slateDevEnvironment.HAS_INPUT_EVENTS_LEVEL_2) return;
  ...
  function syncTextToAst(editor, slateAstNode, path, newText) {
    ...
    if (numStartingCharsSame + numEndingCharsSame !== oldText.length) {
      ...
      withoutEverNormalizing(editor, function () {
        return editor.controller.fastInsertText(path, numStartingCharsSame, insertions, null);
      });
    }
  }

  function withoutEverNormalizing(editor, cb) {
    if (editor.controller.tmp.dirty.length != 0) return cb();

    var oldValue = editor.controller.tmp.normalize;

    try {
      editor.controller.tmp.normalize = false;
      var ret = cb();

      if (editor.controller.tmp.dirty.lenght === 1) {
        editor.controller.tmp.dirty.pop();
      }
      return ret;
    } finally {
      editor.controller.tmp.normalize = oldValue;
    }
  }
...
var debug$4 = Debug('slate:events');
...
var debug$5 = Debug('slate:batch-events');
...
var debug$6 = Debug('slate:mutations');
...
function DebugMutationsPlugin() {
  var observer = new window.MutationObserver(function (mutations) {
    ...
    debug$6.apply(undefined, [array.length + ' Mutations'].concat(toConsumableArray(array)));
  });
...
var Editor = function (_React$Component) {
  ...
  createClass(Editor, [{
    ...
    value: function render() {
      ...
      var domProps = omit(this.props, Object.keys(Editor.__propTypes));
